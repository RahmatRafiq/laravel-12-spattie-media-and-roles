...
export default function AppSettings({ settings, availableColors }: Props) {
    ...
    const breadcrumbs: BreadcrumbItem[] = [{ title: 'App Settings', href: '/dashboard/app-settings' }];
    ...
    const ColorPicker = ({ value, onChange, label }: { value: string; onChange: (value: string) => void; label: string }) => (
        <div className="space-y-2">
            ...
            <div className="flex gap-2">
                ...
                <div className="h-10 w-10 rounded border border-gray-300" style={{ backgroundColor: value }} />
            </div>
        </div>
    );
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                                <ColorPicker value={data.primary_color} onChange={(value) => setData('primary_color', value)} label="Primary Color" />
                                <ColorPicker
                                    value={data.secondary_color}
                                    onChange={(value) => setData('secondary_color', value)}
                                    label="Secondary Color"
                                />
                                <ColorPicker value={data.accent_color} onChange={(value) => setData('accent_color', value)} label="Accent Color" />
                            </div>
                        </CardContent>
                    </Card>
                    <Card>
